...
public class Combinations {
	 ...
	 * @param words input array to make combinations of
	 */
	 ...
	 * @param words	input file
	 * @param index	index from where to start combination
	 ...
	 * @param words1	first array to be combined
	 * @param words2	second array to be combined
	 * @return	combined array of the two
	 */
	public static String[] combine(String[] words1,String[] words2){
		// Total combinations will be amount of words in array1 multiplied by amount of words in array2
